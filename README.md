...
| [Process Mining Demonstrator — Web Edition](process-mining-demonstrator-web-edition/) | Cross-Industry | A web-based, multiuser environment for Process Mining for demonstration purposes, including the main application, admin console and datasource integration. |
